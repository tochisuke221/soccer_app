...
ActiveRecord::Schema.define(version: 2021_04_19_074849) do
  ...
  create_table "practice_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "practice_id"
    t.bigint "ptag_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["practice_id"], name: "index_practice_tag_relations_on_practice_id"
    t.index ["ptag_id"], name: "index_practice_tag_relations_on_ptag_id"
  end
  ...
  add_foreign_key "practice_tag_relations", "practices"
  add_foreign_key "practice_tag_relations", "ptags"
